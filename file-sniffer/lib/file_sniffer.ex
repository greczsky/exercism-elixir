defmodule FileSniffer do
  ...
  def verify(file_binary, extension) do
    case FileSniffer.type_from_extension(extension) == type_from_binary(file_binary) and
           type_from_binary(file_binary) != nil do
      true -> {:ok, type_from_binary(file_binary)}
